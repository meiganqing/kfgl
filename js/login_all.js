...
$("#qrcode").click(function(){
   ...
   $("#login_qrcode").html("")
// 01，获取我二维码
let smdata=mSubSystemData.SYKFGL.PostDataPublic("GetDataInterface", {
...
function login() {
    ...
    if (flag) {
        SysConfig.UserLogin.UserLogin($("#uname").val(), $("#upsd").val(), $('#phone_forget'), $('#yzm_forget'), loginType, UserLoginCallback);
    }
}
    ...
    if (returnValue.success) {
        layer.msg('登陆成功，正在打开首页！', {
            ...
            time: 800,
                ...
                window.location.href = SysConfig.UserLogin.GetLoginUrl("库房系统");
            }
        });
    } else {
    ...
    try {
        $.ajax({
            ...
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                ...
                if (rv == "NOTLOGIN" || rv == 'Invalid signature') {
                    layer.msg(rv);
